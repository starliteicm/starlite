...
<script type="text/javascript">
        ...
        function onInvokeExportAction(id) {
            ...
            location.href = '${request.contextPath}/myTest.action?' + parameterString;
            <#else>
           <!-- var parameterString = createParameterStringForLimit(id);
            location.href = '${request.contextPath}/myTest!deactive.action?' + parameterString;
            -->
            </#if>
        }
</script>
...
<div id="toolbar">
    <a href="${request.contextPath}/myTest!edit.action"><img src="${request.contextPath}/images/icons/add.png"/>Add</a>
